...
let series = [
{"id":"1","name":"Ленинградский эксперимент","youtube_link":"6KfUac55k1g","descr":"Путешествия во времени невозможны. Только если у тебя нет таинственного кристалла. Но будь осторожен. У всего в этом мире есть последствия.","year":"2020","genre":"Фантастика","duration":"4 мин","fraction":"mff","fraction_name":"МФФ","likes":"0","bangers_is_enabled":true,"series_is_enabled":true, likes: false, text: "Эпизод факультета Фотоники"},
{"id":"3","name":"Обратная сторона звезды","youtube_link":"ghvbrLidi7w","descr":"Инопланетяне ближе, чем вы думаете. Возможно, вы даже знаете их песни, ходите на их концерты, покупаете одежду их лейбла и едите их бургеры. Пришло время во всем разобраться.","year":"2020","genre":"Расследование","duration":"4 мин","fraction":"ftmi","fraction_name":"ФТМИ","likes":"0","bangers_is_enabled":true,"series_is_enabled":true, likes: false, text: "Эпизод факультета ФТМИ"},
{"id":"4","name":"Ктукла","youtube_link":"uKwqR2ymaNY","descr":"Игра вышла из-под контроля. Теперь не смешно уже никому. Обычная кукла принесла слишком много проблем. Как спасти себя и друзей от старого проклятья?","year":"2020","genre":"Ужасы","duration":"5 мин","fraction":"ktu","fraction_name":"КТиУ","likes":"0","bangers_is_enabled":true,"series_is_enabled":true, likes: false, text: "Эпизод факультета КТиУ"},
{"id":"6","name":"Скрываясь за маской","youtube_link":"XwKYF1aub4k","descr":"Маски в Instagram прочно вошли в нашу жизнь. А в жизнь четырех друзей даже слишком прочно. Виртуальный мир перешел в реальность. Теперь им остается только открыть свое истинное лицо, чтобы стать свободными.","year":"2020","genre":"Комедия","duration":"5 мин","fraction":"btins","fraction_name":"БТИНС","likes":"0","bangers_is_enabled":true,"series_is_enabled":true, likes: false, text: "Эпизод факультета БТИНС"}
]
let voting = [
{"id":"1","fraction":"mff","fraction_name":"МФФ","type":"bangers","is_enabled":"1"},
{"id":"2","fraction":"ftmi","fraction_name":"ФТМИ","type":"bangers","is_enabled":"1"},
{"id":"4","fraction":"ktu","fraction_name":"КТУ","type":"bangers","is_enabled":"1"},
{"id":"5","fraction":"btins","fraction_name":"БТИНС","type":"bangers","is_enabled":"1"},
...
let bangers = [
{"id":"1","name":"Бэнгер","text":"Бэнгер факультета Фотоники","fraction":"mff","youtube_link":"q0YWP0QKZQs","bangers_is_enabled":true},
