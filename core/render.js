...
{"id":"3","name":"Обратная сторона звезды","youtube_link":"K09_5IsgGe8","descr":"Инопланетяне ближе, чем вы думаете. Возможно, вы даже знаете их песни, ходите на их концерты, покупаете одежду их лейбла и едите их бургеры. Пришло время во всем разобраться.","year":"2020","genre":"Расследование","duration":"4 мин","fraction":"ftmi","fraction_name":"ФТМИ","likes":"0","bangers_is_enabled":true,"series_is_enabled":false, likes: false, text: "Эпизод факультета ФТМИ"},
...
{"id":"6","name":"Скрываясь за маской","youtube_link":"pz1ztvu77FM","descr":"Маски в Instagram прочно вошли в нашу жизнь. А в жизнь четырех друзей даже слишком прочно. Виртуальный мир перешел в реальность. Теперь им остается только открыть свое истинное лицо, чтобы стать свободными.","year":"2020","genre":"Комедия","duration":"5 мин","fraction":"btins","fraction_name":"БТИНС","likes":"0","bangers_is_enabled":true,"series_is_enabled":false, likes: false, text: "Эпизод факультета БТИНС"}
]
let voting = [
